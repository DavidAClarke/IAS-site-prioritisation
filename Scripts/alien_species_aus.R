...
#yes it does. Therefore, not necessary to do this. just use aliens_Aus_taxalist$species
...
#Match the names
gbif_taxon_keys <- alien_names %>% #speciesNames = combination of harmonized range map and plant occurrence species (see RedList.R)
...
#Although GDM analysis for Aus wouldn't require this
res <- occ_download(
...
#Download data - use path of an external hard drive
#Download key: 0314789-200613084148143
#Total records: 23572690
occ_download_get("0314789-200613084148143", path = file.path("SpatialData", "Vector", "SpeciesOccurrences", "GBIF"))
