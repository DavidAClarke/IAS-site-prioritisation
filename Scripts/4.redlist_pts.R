...
# drop_upload(file = file.path("Scripts", "4.redlist_pts.R"), 
#             path = file.path("PhD", "Thesis", "Data", "Chapter_3", "Scripts"))
# 
# drop_download(path = file.path("PhD", "Thesis", "Data", "Chapter_3", "Scripts", "4.redlist_pts.R"),
#               local_path = file.path("Scripts", "4.redlist_pts.R"), overwrite = T)
